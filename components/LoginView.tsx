...
export default function LoginView({ onLogin }: LoginViewProps) {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center py-6 px-4 sm:px-6 lg:px-8 w-full">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-3xl border border-gray-150 shadow-md">
        ...
        <div className="pt-6 border-t border-gray-150 relative font-sans">
            ...
            {demoAccounts.map((account) => {
              ...
              return (
                <button
                  ...
                  className={`w-full p-3.5 rounded-xl border flex items-start gap-4 text-left transition-all duration-150 cursor-pointer ${account.bgColor}`}
                >
