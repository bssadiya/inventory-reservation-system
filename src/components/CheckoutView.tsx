    ...
    <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-6 md:p-8">
      ...
      <div className="border border-indigo-100/60 bg-indigo-50/10 rounded-2xl p-5 md:p-6 mb-6">
        ...
        <div className="mt-5">
          ...
          <div className="flex justify-between items-center text-[10px] text-gray-400 mt-1.5 uppercase font-medium tracking-wider">
      ...
      <div className="bg-gray-50 border border-gray-200/65 rounded-2xl p-4 md:p-5 mb-6">
        ...
        {useIdempotency && (
          <div className="mt-3.5 pt-3.5 border-t border-gray-200/50 flex flex-col md:flex-row items-stretch md:items-center gap-2">
            <div className="flex-1">
              <label className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Dynamic key payload header</label>
              <input
                type="text"
                value={customKey}
            ...
            <button
              ...
              disabled={isExpired}
              className="px-3 py-1.5 self-end mt-4 text-[11px] font-semibold text-gray-600 hover:text-gray-900 border border-gray-200 hover:border-gray-300 rounded-lg bg-white flex items-center gap-1"
            >
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        <button
          ...
          className={`px-5 py-3 border rounded-xl transition flex items-center justify-center gap-1.5 ${
